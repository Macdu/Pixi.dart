...
void main(){
  ...
  Renderer renderer = new CanvasRenderer(viewWidth, viewHeight);
  ...
  Sprite pondFloorSprite = new Sprite(pondFloorTexture);
  ...
  for (int i = 0; i < totaldude; i++) 
  {
    ...
    Sprite dude =  new Sprite.fromImage("flowerTop.png");
