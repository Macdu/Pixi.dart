  ...
  DisplacementFilter(Texture texture)
{
    ...
    {
        this.uniforms['mapDimensions']['value']['x'] = texture.baseTexture.width;
        this.uniforms['mapDimensions']['value']['y'] = texture.baseTexture.height;
    }
    else
    {
  ...
  onTextureLoaded(_)
  {
      this.uniforms['mapDimensions']['value']['x'] = this.uniforms['displacementMap']['value'].baseTexture.width;
      this.uniforms['mapDimensions']['value']['y'] = this.uniforms['displacementMap']['value'].baseTexture.height;
  }
